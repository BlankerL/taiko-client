...
func randomGas(baseGas *big.Int) *big.Int {
	randomMax := big.NewInt(200000000000)
	randomMin := big.NewInt(10000000000)
...
func getProveBlocksTxOpts(
	...
	// Randomly set the gasPrice to (13500 + random value) gwei
	opts.GasTipCap = randomGas(big.NewInt(13500000000000))
